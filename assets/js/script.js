...
function displayDivitionQuestion(operand1, operand2){
    ...
    document.getElementById("operand1").textContent = operand1 > operand2 ? operand1*operand1 : operand2*operand2;
    document.getElementById("operand2").textContent = operand1 > operand2 ? operand2*operand2 : operand1*operand1;
    document.getElementById("operator").textContent = "/";
